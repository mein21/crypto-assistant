...
RR (reward/risk) ≥ ${DEFAULT_MIN_RR}: для LONG (tp-entry)/(entry-sl) ≥ ${DEFAULT_MIN_RR}; для SHORT (entry-tp)/(sl-entry) ≥ ${DEFAULT_MIN_RR}. RR ниже — это HET, никогда не возвращай LONG/SHORT с RR<${DEFAULT_MIN_RR}.
